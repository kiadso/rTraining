...
- Sign up for a free [GitHub](https://github.com/) account. (There are other git platforms like GitLab and others- it is ok to choose whichever you want but I am using GitHub because I know more about it.)
