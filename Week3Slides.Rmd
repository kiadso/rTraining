...
It makes it possible for multiple developers to work on code at the same time and merge changes, resolve conflicts where two developers have modified the same line of code.

## Why do we need it as HMIS Admins?

1. Many of us are already doing it manually.
